...
const defaultMarkers: CdnMarker[] = [
  ...
  { id: "netplus-tun", location: [36.80, 10.18], region: "tun1" },
]
...
const defaultArcs: CdnArc[] = [
  ...
  { id: "cdn-arc-7", from: [49.01, 2.55], to: [36.80, 10.18] },
]
...
export function GlobeCdn({
  ...
  const [traffic, setTraffic] = useState(() =>
    defaultArcs.map((a, i) => ({ id: a.id, value: [420, 380, 290, 185, 156, 134, 500][i] || 100 }))
  )
