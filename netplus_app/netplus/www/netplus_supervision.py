...
ALLOWED_ROLES = {"NetPlus Supervisor", "NetPlus Admin", "System Manager", "Administrator"}
...
def get_context(context):
    if frappe.session.user == "Guest":
        frappe.local.flags.redirect_location = "/netplus-login?redirect-to=/netplus-supervision"
